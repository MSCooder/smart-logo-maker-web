  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          Transform your brand vision into reality with AI-powered logo <br/> generation. Professional designs made easy.
        </motion.p>
        ...
        >
          ...
          {/* Secondary Button */}
          <button className="px-10 py-4 text-[#0f172a] font-bold text-lg border-2 border-gray-100 rounded-full bg-white hover:border-[#0f172a] hover:text-[#0f172a] hover:scale-105 active:scale-95 transition-all duration-300 shadow-sm">
            See How It Works
          </button>
        </motion.div>
      </div>
