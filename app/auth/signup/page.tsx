...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-br from-[#fdfbfb] via-[#f6f7fb] to-[#eef2ff] px-4 md:px-12 overflow-hidden">
      ...
      {/* RIGHT SIDE (NOW FIRST - ILLUSTRATION) */}
      ...
      <div className="w-full max-w-md bg-white/85 backdrop-blur-xl rounded-3xl shadow-[0_18px_55px_rgba(0,0,0,0.14)] px-6 py-5 z-10">
        ...
        <div className="flex items-start gap-2 mt-3 text-[11.5px] text-gray-900">
          <input type="checkbox" className="accent-pink-500 mt-0.5" />
          <span>
            I agree to the{" "}
        ...
        <button className="w-full mt-3 h-9 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-orange-500 to-pink-500 hover:opacity-90 transition shadow-md">
          Create Account
        </button>
        ...
        <button onClick={handleGoogleLogin} className=" w-full h-9 rounded-xl border border-gray-300 flex items-center justify-center gap-2 text-sm text-gray-900 font-medium hover:bg-gray-100 transition">
