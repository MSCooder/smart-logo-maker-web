          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex flex-col">
               <input 
                 ...
                 className="bg-transparent border-none font-bold text-slate-800 outline-none focus:ring-0 p-0 text-lg"
                 placeholder="Brand Name"
               />
               <span className="text-[10px] text-gray-400 font-bold uppercase tracking-tighter">Live Editor</span>
            </div>
          </div>
